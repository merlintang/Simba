...
import org.apache.spark.sql.simba.util.{BoundedPriorityQueue, ShapeUtils}
...
case class VKJSpark(left_key: Expression, right_key: Expression, l: Literal,
  ...
  final val num_of_pivot_sets = simbaSesstionState.simbaConf.voronoiPivotSetSize
  final val num_of_pivots = num_partitions * simbaSesstionState.simbaConf.thetaBoost
