...
private[simba] case class IndexedRelationScan(attributes: Seq[Attribute],
  ...
  private val selectivity_enabled = simbaSesstionState.simbaConf.indexSelectivityEnable
  private val s_level_limit = simbaSesstionState.simbaConf.indexSelectivityLevel
  private val s_threshold = simbaSesstionState.simbaConf.indexSelectivityThreshold
  private val index_threshold = simbaSesstionState.simbaConf.indexSizeThreshold
